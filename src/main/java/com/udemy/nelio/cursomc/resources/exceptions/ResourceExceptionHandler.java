package com.udemy.nelio.cursomc.resources.exceptions;
...
import com.udemy.nelio.cursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e,
        ...
        ValidationError err = new ValidationError(HttpStatus.BAD_REQUEST.value(),
                "Error de validação", System.currentTimeMillis());
